"""added priority and due date for group tasks

Revision ID: 7e443e53c764
Revises: 00e7562d94c3
Create Date: 2026-09-05 17:07:14.180082
...
revision: str = '7e443e53c764'
down_revision: Union[str, Sequence[str], None] = '00e7562d94c3'
...
def upgrade() -> None:
    ...
    op.add_column('group_tasks', sa.Column('priority', sa.Enum('LOW', 'MEDIUM', 'HIGH', 'URGENT', name='priority'), server_default='MEDIUM', nullable=False))
    op.add_column('group_tasks', sa.Column('due_date', sa.DateTime(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('group_tasks', 'due_date')
    op.drop_column('group_tasks', 'priority')
